...
%Stryker this is probably what gives us the flash.
else %% stim == 3
    clut=0;
end
...
%         end
        ...
        if DoNearScreen
            ...
            cp_azdeg=0; cp_eldeg=0; cpx_cm=20; cpy_cm=10; %SEt these in dialog box
            img3 = NearScreen(img, cp_azdeg, cp_eldeg, str2double(get(handles.ScreenDist,'String')), cpx_cm, cpy_cm, ...
                degPerPix, imageRect(3), imageRect(4), imageRect(3)/str2double(get(handles.SizeX,'String')),str2double(get(handles.SizeX,'String')),str2double(get(handles.SizeY,'String')) );
            textures(c,1)=Screen('MakeTexture',window,img);
        else
            textures(c,1)=Screen('MakeTexture',window,img);
        end
